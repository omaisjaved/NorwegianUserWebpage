...
public class faqIsClicked extends Homepage {

    @Test(priority = 1)

    public void verifyFAQIsClicked() throws IOException {

    System.out.println("-------");

    System.out.println("Home page test 1 for clicking on faq in the top navigation options");
